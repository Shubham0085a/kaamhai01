...
const RefundPolicy = () => {
  return (
    <div className=" px-5">
      <h1 className=" text-2xl font-semibold">Return and Refund Policy</h1>
      <p>Last updated: May 25, 2024</p>
      <p>Thank you for shopping at Kaamhai.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to OFFBEAT TECHNET PRIVATE LIMITED, HD-428,
            WeWork Prestige, Atlanta, 80 Feet, Koramangala, Bangalore South,
            Bangalore- 560034 IN.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kaamhai, accessible from{" "}
            <a
      ...
      <ul>
        <li>
          <p>By email: connect@kaamhai.in</p>
        </li>
        <li>
          <p>By phone number: +91 7090151000</p>
        </li>
      </ul>
      <p>
