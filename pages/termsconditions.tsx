...
const TermsConditions = () => {
  return (
    <div className=" px-5">
      <h1 className=" text-2xl font-semibold">Terms and Conditions for OFFBEAT TECHNET PRIVATE LIMITED</h1>

      <h2 className=" text-xl font-semibold">Introduction</h2>

      <p>
        These Website Standard Terms and Conditions written on this webpage
        shall manage your use of our website, Kaamhai accessible at
      ...
      <p>
        Other than the content you own, under these Terms, OFFBEAT TECHNET
        PRIVATE LIMITED and/or its licensors own all the intellectual property
      ...
      <p>
        ...
        and OFFBEAT TECHNET PRIVATE LIMITED may further restrict access by you
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant OFFBEAT
        TECHNET PRIVATE LIMITED a non-exclusive, worldwide irrevocable, sub
      ...
      <p>
        ...
        third-party&apos;s rights. OFFBEAT TECHNET PRIVATE LIMITED reserves the
      ...
      <p>
        This Website is provided &quot;as is,&quot; with all faults, and OFFBEAT
        TECHNET PRIVATE LIMITED express no representations or warranties, of any
      ...
      <p>
        In no event shall OFFBEAT TECHNET PRIVATE LIMITED, nor any of its
        ...
        whether such liability is under contract. OFFBEAT TECHNET PRIVATE
        LIMITED, including its officers, directors and employees shall not be
      ...
      <p>
        You hereby indemnify to the fullest extent OFFBEAT TECHNET PRIVATE
      ...
      <h2 className=" text-xl font-semibold">Variation of Terms</h2>

      <p>
        OFFBEAT TECHNET PRIVATE LIMITED is permitted to revise these Terms at
      ...
      <p>
        The OFFBEAT TECHNET PRIVATE LIMITED is allowed to assign, transfer, and
      ...
      <p>
        These Terms constitute the entire agreement between OFFBEAT TECHNET
        PRIVATE LIMITED and you in relation to your use of this Website, and
