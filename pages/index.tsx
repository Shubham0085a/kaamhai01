          ...
          <div>
            <div>
              <Image
                src={kaamhailogo}
                alt=""
                className="footer_logo h-[85px] w-[185px]"
              ></Image>
            </div>
            <div>
              <h1 className=" c pb-4">
      ...
      <footer className="bg-[#F2F1EE]">
        <div className="mx-auto max-w-screen-2xl space-y-8 px-5 2xl:px-0  pt-10 pb-4  lg:space-y-16 ">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-teal-600">
                <Image src={Logo} alt="" className="footer_logo h-[52px] w-[185px]" />
              </div>
          ...
          <p className=" text-center">
            &copy; 2024 <span className=" font-bold">Kaamhai</span>. All rights reserved.
          </p>
        </div>
      </footer>
    </main>
