...
export default function Example() {
  ...
  return (
    <header className="bg-white z-[9999] fixed w-full top-0">
      <nav
      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Kaamhai</span>
            <Image
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 ml-0"> 
          ...
          <a href="#about" className="text-base hover:font-bold hover:text-black font-semibold leading-6 text-gray-600">
            About
          </a>
          <a href="#contact" className="text-base hover:font-bold hover:text-black font-semibold leading-6 text-gray-600">
          Let&apos;s Talk Business!
          </a>
        </PopoverGroup>
